...
<div class="container main-container">
	<form class="needs-validation" action="/cc_update" method="post" autocomplete="off" novalidate>
		@csrf
		<div class="row justify-content-center mb-5">
		<span class="h3">接種券番号未登録</span>
		</div>
		<div class="row justify-content-center mb-5">
		<span class="h4">接種記録を検索しますのでお名前または電話番号と事業所を入力してください</span>
		</div>
		<div class="form-row">
		...
		<div class="form-row">
			<div class="form-group col-12">
				<label for="phone">事業所&nbsp;<span class="badge badge-danger">必須</span></label>
				<input class="form-control" type="text" name="office" id="office" value="{{old('office')}}"  placeholder="✕✕病院、〇〇保育園" required>
				<div class="invalid-feedback">
					事業所を入力してください
				</div>
			</div>				
		...
		<div class="row justify-content-center mt-5">
			<div class="form-group col-6">
				<button class="btn btn-outline-primary fit-btn" id="back-btn" type="button" onclick="location.href='/sp';">戻る</button>
			</div>
			<div class="form-group col-6">
