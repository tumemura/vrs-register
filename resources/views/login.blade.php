...
<form class="needs-validation" action="/login" method="post" autocomplete="off" novalidate> 
		@csrf
		<div class="row justify-content-center mb-5">
			<span class="h3">ログイン(予約確認）</span>
		</div>
		...
		<div class="form-group col-12">
			...
			<input class="form-control" type="text" name="date_of_birth" id="date_of_birth" value="" inputmode="numeric" pattern="^[1-2]\d{7}" placeholder="19210501" required>
