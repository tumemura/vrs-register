...
(function() {
    ...
    window.addEventListener('load',function() {
        ...
        @if (!empty($second_dose_date))
            document.getElementById('dose4').checked = false;
            document.getElementById('dose3').checked = true;
        @else 
            document.getElementById('dose4').checked = true;
            document.getElementById('dose3').checked = false;
        @endif
...
function doseChanged(e) {
    if (e.currentTarget.checked) {
        if (e.currentTarget.value == 4) {
            document.getElementById('third-dose-row').style.display="flex";
            document.getElementById('second-dose-row').style.display="none";
            document.getElementById('third-dose-image').style.display="block";
            document.getElementById('second-dose-image').style.display="none";
            document.getElementById('second_dose_date').required = false;
            document.getElementById('third_dose_date').required = true;
        } else {
            document.getElementById('second-dose-row').style.display="flex";
            document.getElementById('third-dose-row').style.display="none";
            document.getElementById('second-dose-image').style.display="block";
            document.getElementById('third-dose-image').style.display="none";
...
@csrf
    ...
    <div class="form-row" id="second-dose-row" style="display:none"> 
        <div class="form-group col-12">
